...
// --- SOIL MOISTURE CALIBRATION THRESHOLDS ---
// These limits represent the raw ADC values for this specific soil composition.
// Values were determined empirically via physical testing.

const int dryValue = 133; // Raw ADC reading at the physical wilting point (0% baseline)
const int wetValue = 115; // Raw ADC reading at maximum soil saturation (100% baseline)
